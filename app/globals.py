...
provide_exemplar: bool = False

provide_general_cross_episode_knowledge: bool = False

provide_repository_level_cross_episode_knowledge: bool = False

# whether to use self-reflections
