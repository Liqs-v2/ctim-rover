...
You ultimate goal is to write a list of locations that you can give to another software engineer.
"""


USER_PROMPT_INIT = """Write a list of fix locations, based on the retrieved context.\n\n
Return the list of locations in the format below.\n\nWithin `<file></file>`, replace `...` with the actual file path. Within `<class></class>`, replace `...` with a class name if needed. Within `<method></method`, replace `...` with a method name.\n\n
